  ...
  return (
    <div className="">
      ...
      <div className="w-full h-40 lg:h-48 relative">
        ...
        <img src={cajaun.src} className="object-cover rounded-full w-24 border-4 border-light-neutral dark:border-black" alt="Florian as a student"/>
        </div>
        </div></div>
      ...
      >
        <div className="space-y-4 p-5 animate-slide-down-fade">
          <h3 className="text-xl font-bold  text-black dark:text-impureWhite">About me</h3>

          <p className="text-offGray dark:text-secondary">
            {" "}
            am a designer currently shaping the native mobile apps at Linear and crafting app icons for a variety of clients.
        ...
        >
          <h3 className="text-xl font-bold  text-black dark:text-impureWhite">Now</h3>
        ...
        >
          <h3 className=" text-black dark:text-impureWhite text-xl font-bold px-5">Projects</h3>
...
<div className="">
        ...
        >
          ...
          <h3 className=" text-black dark:text-impureWhite text-xl font-bold ">Blog</h3>
      ...
      <path d="M5 12h14M12 5l7 7-7 7" />
          ...
          <div className="">
            <div className="py-4 px-5">
              <p className=" text-black dark:text-impureWhite font-bold ">2024</p>
            </div>
        ...
        >
          <h3 className="text-xl font-bold  text-black dark:text-impureWhite">Connect</h3>
